...
LicenseLabel=Пожалуйста, прочтите следующую информацию перед тем, как продолжить.
...
InfoBeforeLabel=Пожалуйста, прочитайте следующую информацию перед тем, как продолжить.
...
SelectComponentsLabel2=Выберите компоненты, которые вы хотите установить, и нажмите «Далее».
...
Allusrs=Для всех пользователей
Currusr=Только для текущего пользователя
RunSysPrep=Запустить инструмент подготовки системы
RunManual=Руководство пользователя
RunDonate=Поддержать проект
RunUnInstallWarn=Внимание! В процессе деинсталляции будут удалены все каталоги (включая сайты, базы данных и проч.). Пожалуйста, убедитесь в том, что вы сохранили важные данные.%n%nЗакройте программу перед началом процедуры деинсталляции.%n%nПродолжить?
CoreData=Панель управления
ImportCert=Установить корневой сертификат (ЦС)
ImportingCert=Установка корневого сертификата (ЦС)...
GenCerts=Генерация SSL-сертификатов...
GeneralData=Базовые компоненты
Geobases=Географические базы данных (GeoIP и др.)
Browscap=Расширенные базы данных Browscap
AddToPath=Добавить каталог с программой в переменную PATH
PathCheckError=Допустимые символы пути (не более 32-х символов): A-Z,a-z,0-9,.,+,-,\,:,_
PartitionTypeError=Недопустимый тип файловой системы (поддерживается только NTFS)
DiskTypeError=Недопустимый тип диска
DiskStateError=Указанный каталог находится на сжатом NTFS-томе. Установка невозможна. Пожалуйста, выберите другой каталог.
InstallationMode=Выберите режим установки
InstallationModeDescr=Какой режим установки приложения использовать?
NormalInstallation=Обычная установка
PortableInstallation=Портативная установка
NormalInstallationDescr=Обычная установка даёт возможность интегрировать приложение в операционную систему, а также выполнить его деинсталляцию при необходимости.
PortableInstallationDescr=Портативный режим позволяет выполнить распаковку приложения в выбранный каталог без установки в систему. В этом режиме недоступно создание ярлыков приложения, добавление его в автозагрузку и интеграция с переменной PATH.
WantToDeleteDataFolder=Вы хотите оставить каталог данных "data"?
WantToDeleteHomeFolder=Вы хотите оставить каталог проектов "home"?
