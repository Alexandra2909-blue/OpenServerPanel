...
SelectComponentsLabel2=Select the components you want to install and click Next.
...
Allusrs=For all users
Currusr=For the current user only
RunSysPrep=Launch the System Preparation tool
RunManual=User's manual
RunDonate=Donate to the project
RunUnInstallWarn=Attention! During the uninstallation process, all directories (including sites, databases, etc.) will be deleted. Please make sure to save important data.%n%nClose the program before starting the uninstall procedure.%n%nContinue?
CoreData=Control Panel
ImportCert=Install the Root Certificate (CA)
ImportingCert=Installation of the Root Certificate (CA)...
GenCerts=Generation of SSL certificates...
GeneralData=Basic components
